...
export class Client extends ClientBase {
     ...
     */
    getEntryListing(repoId: string, entryId: number, groupByEntryType?: boolean | undefined, fields?: string[] | null | undefined, formatFields?: boolean | undefined, prefer?: string | null | undefined, culture?: string | null | undefined, select?: string | null | undefined, orderby?: string | null | undefined, top?: number | undefined, skip?: number | undefined, count?: boolean | undefined): Promise<ODataValueContextOfIListOfODataGetEntryChildren> {
    ...
    protected processGetEntryListing(response: Response): Promise<ODataValueContextOfIListOfODataGetEntryChildren> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ODataValueContextOfIListOfODataGetEntryChildren.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ODataValueContextOfIListOfODataGetEntryChildren>(null as any);
    }
     ...
     */
    getSearchResults(repoId: string, searchToken: string, groupByEntryType?: boolean | undefined, refresh?: boolean | undefined, fields?: string[] | null | undefined, formatFields?: boolean | undefined, prefer?: string | null | undefined, culture?: string | null | undefined, select?: string | null | undefined, orderby?: string | null | undefined, top?: number | undefined, skip?: number | undefined, count?: boolean | undefined): Promise<ODataValueContextOfIListOfODataGetSearchResults> {
    ...
    protected processGetSearchResults(response: Response): Promise<ODataValueContextOfIListOfODataGetSearchResults> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ODataValueContextOfIListOfODataGetSearchResults.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ODataValueContextOfIListOfODataGetSearchResults>(null as any);
    }
     ...
     */
    createSimpleSearchOperation(repoId: string, select?: string | undefined, orderby?: string | undefined, count?: boolean | undefined, fields?: string[] | null | undefined, formatFields?: boolean | undefined, request?: SimpleSearchRequest | undefined, culture?: string | null | undefined): Promise<ODataValueOfIListOfODataGetEntryChildren> {
    ...
    protected processCreateSimpleSearchOperation(response: Response): Promise<ODataValueOfIListOfODataGetEntryChildren> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ODataValueOfIListOfODataGetEntryChildren.fromJS(resultData200);
            return result200;
            });
        } else if (status === 204) {
            return response.text().then((_responseText) => {
            ...
            result206 = ODataValueOfIListOfODataGetEntryChildren.fromJS(resultData206);
            return result206;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ODataValueOfIListOfODataGetEntryChildren>(null as any);
    }
...
export class ODataValueOfIListOfODataGetEntryChildren implements IODataValueOfIListOfODataGetEntryChildren {
    value?: ODataGetEntryChildren[];

    constructor(data?: IODataValueOfIListOfODataGetEntryChildren) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(ODataGetEntryChildren.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ODataValueOfIListOfODataGetEntryChildren {
        data = typeof data === 'object' ? data : {};
        let result = new ODataValueOfIListOfODataGetEntryChildren();
        result.init(data);
        return result;
    }
...
export interface IODataValueOfIListOfODataGetEntryChildren {
    value?: ODataGetEntryChildren[];
}

/** A wrapper around the ODataValue with extra odata.nextLink and odata.count. */
export class ODataValueContextOfIListOfODataGetEntryChildren extends ODataValueOfIListOfODataGetEntryChildren implements IODataValueContextOfIListOfODataGetEntryChildren {
    /** It contains a URL that allows retrieving the next subset of the requested collection. */
    odataNextLink?: string | undefined;
    /** It contains the count of a collection of entities or a collection of entity references. */
    odataCount?: number;

    constructor(data?: IODataValueContextOfIListOfODataGetEntryChildren) {
        super(data);
    }
    ...
    static fromJS(data: any): ODataValueContextOfIListOfODataGetEntryChildren {
        data = typeof data === 'object' ? data : {};
        let result = new ODataValueContextOfIListOfODataGetEntryChildren();
        result.init(data);
        return result;
    }
...
/** A wrapper around the ODataValue with extra odata.nextLink and odata.count. */
export interface IODataValueContextOfIListOfODataGetEntryChildren extends IODataValueOfIListOfODataGetEntryChildren {
    /** It contains a URL that allows retrieving the next subset of the requested collection. */
    odataNextLink?: string | undefined;
    /** It contains the count of a collection of entities or a collection of entity references. */
    odataCount?: number;
